...
(async function () {
  ...
  function showSuspended() {
    ...
    const css = ('@keyframes rkSusFade{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:none}}'
      ...
      + '#suspendedOverlay .rk-body{font-size:16px;max-width:440px;line-height:1.65;opacity:0.78;margin:0 0 34px;}'
    ...
    o.innerHTML = (
      ...
      + (igHandle ? '<a class="rk-ig" href="' + igLink + '" target="_blank" rel="noopener">' + IG_SVG + ' Visit our Instagram</a>' : '')
    );
